...
That's right: missing a single character made my site **27% slower**! Unacceptable!!
...
| Step | Action               | Without `/`                                 | Duration   | With `/`                                    | Duration  |
| ---- | -------------------- | ------------------------------------------- | ---------- | ------------------------------------------- | --------- |
| 1    | DNS lookup           | github.com                                  | 2ms        | github.com                                  | 2ms       |
| 2    | TCP handshake        |                                             | 50ms       |                                             | 8ms       |
| 3    | TLS handshake        |                                             | 17ms       |                                             | 14ms      |
| 4    | Request              | GET /posts/article                          |            | GET /posts/article/                         |           |
| 5    | Response             | 301 Redirect                                | 20ms       | <span style="color: #28a745;">200 OK</span> | 34ms      |
| 6    | Follow redirect      |                                             |            | —                                           | —         |
| 7    | Request (redirected) | GET /posts/article/                         | 35ms       | —                                           | —         |
| 8    | Response             | <span style="color: #28a745;">200 OK</span> |            | —                                           | —         |
|      | **Total**            |                                             | **~124ms** |                                             | **~58ms** |
