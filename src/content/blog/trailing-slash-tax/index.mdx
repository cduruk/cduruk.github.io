...
I was kind of surprised that a mere 33ms felt so different. Here's my guess on why it seemed to matter that much. First of all, we know from cog sci research that humans can detect delays up to 100ms. 33ms isn't that slow, but it's a third of that 100ms budget. And it's very likely that with those extra milliseconds, we went from imperceptible to perceptible delay.
