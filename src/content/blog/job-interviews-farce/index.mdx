---
title: 'Are job interviews a farce?'
description: 'Why hiring decisions are chaotic and random at the individual level—and what both candidates and companies can do about it'
date: 2020-02-27
tags: ['hiring', 'tech-industry', 'margins']
...
import quadrant1 from './quadrant1.jpg';
import quadrant2 from './quadrant2.jpg';
import dehumanizing from './dehumanizing.gif';
...
I mean, I don't hate them. More often than not, I look forward to meeting new potential co-workers, getting to know them as the people they are, am happy to answer their questions about the company, and sure, do my best being objective while I judge them on their merits. I'm reasonably good at it too. I've probably given more than a few hundred interviews <sup>[1]</sup> so far, and no one ever left any of them crying or sent me angry emails afterward. That might sound like a low bar to clear, but you'd be surprised. I have done both. <sup>[2]</sup>
...
<Image src={quadrant1} alt="Ideal hiring model quadrant" />
...
<Image src={quadrant2} alt="Realistic hiring model quadrant showing chaos" />

## Bad News for Good People

Is this really a bad thing? I am not actually sure.

One way to read this is that if you ever got dinged, that is rejected, after an interview that you think went really well, it probably wasn't your fault. It could be, and it probably was to some degree. But it also could be that you just got lost in the fray. That should be somewhat consoling.
...
- The engineering manager, who had never written a single line of code in their life, never managed a team that worked on production systems, but was hired because every other engineering manager was on the cusp of quitting if we didn't hire someone new,
...
<Image src={spectrum} alt="Hiring models spectrum" />
