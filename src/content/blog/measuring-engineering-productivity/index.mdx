...
This principle applies beyond just productivity measurement—I use the same approach when designing [take-home exercises for hiring](/posts/take-home-exercises/). Clear expectations and concrete examples make all the difference.
