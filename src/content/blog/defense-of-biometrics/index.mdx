...
There are so many things wrong with passwords. For starters, many of you use, somewhat ironically, again, but from the other side this time, a single password for all the services you use. "Password re-use" is the industry term here, and it's so rampant that it's pretty likely that if you've been using re-using a password for a while, it's probably out in the clear in many of the hacked databases already. I know mine is. In fact, you can even read about [*my password*](https://techcrunch.com/2019/02/11/620-million-hacked-accounts-dark-web/) on TechCrunch.
