...
Limited scope also helps answer the "I want to be paid for this" question. I was surprised how this was almost never an issue; out of hundreds of candidates, only 2 people demanded payment. We rejected both, and one of them did the exercise anyway.
...
This is the simplest part. You are now squarely asessing the interest. I found it best to make a sharable Notion page that included an overview, detailed instructions, delivery instructions, FAQs, and the rest. Here's a very basic sample:
...
Now comes the important part. For me, the good candidates didn't just solve the problem but shared our values. Largely, I wanted folks who had good taste and wrote good code, where good was defined as "easy to change". The assessment criteria here mirrors how I think about [measuring engineering productivity](/posts/measuring-engineering-productivity/) on the job. 
